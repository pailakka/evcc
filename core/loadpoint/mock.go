...
func (m *MockAPI) GetPlan(targetTime time.Time, requiredDuration time.Duration, strategy api.PlanStrategy) api.Rates {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPlan", targetTime, requiredDuration, strategy)
	ret0, _ := ret[0].(api.Rates)
	return ret0
}

// GetPlan indicates an expected call of GetPlan.
func (mr *MockAPIMockRecorder) GetPlan(targetTime, requiredDuration, strategy any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPlan", reflect.TypeOf((*MockAPI)(nil).GetPlan), targetTime, requiredDuration, strategy)
}
